...
This plugin is the successor to the "View/Edit Page in Git Repository" feature originally built into the [Open Publishing Space](https://github.com/hibbitts-design/grav-skeleton-open-publishing-space) skeleton – extracting that capability from a single theme into a standalone plugin compatible with a wide range of existing Grav themes.
